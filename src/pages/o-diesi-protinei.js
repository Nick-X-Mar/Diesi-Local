...
export default oDiesiProtinei;

export const pageQuery = graphql`
    query categoryoDiesiProtinei {
        categories: allApiArticles(
            sort: { order: DESC, fields: published_at }
            filter: { alternative_id: { ne: null }, active: { eq: 1 }, category: { slug: { eq: "o-diesi-protinei" } } }
        ) {
            articles: nodes {
